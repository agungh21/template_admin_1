...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    if (showCatBtns) {
        $.each(showCatBtns, function (indexInArray, valueOfElement) {
            var catSubMenu = valueOfElement.nextElementSibling;
            valueOfElement.addEventListener('click', function (e) {
              e.preventDefault();
              catSubMenu.classList.toggle('visible');
              var catBtnToRotate = $(this).find('.category__btn');
              catBtnToRotate.toggleClass('rotated');
            });
        });
    }
  })();
